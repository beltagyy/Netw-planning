...
n = 42; %Number of users multiplied by 6 rrh's
finished=false;
while(finished~=true)
    i = 1;
    value=true;
...
Solution1 = reshape(Solution1,6,7)';% 6 RRHS 7 USERS
...
Solution2 = reshape(Solution2,6,7)'; %6 RRHS 7 USERS
...
%CHECKING 2ND CONSTRAINT EACH RRH have maxium RBS Q
 if(rrh1&&rrh2&&rrh3&&rrh4&&rrh5&&rrh6<35)
 end
sum(rbs_val1);
%Cal.Rbs sol2
rrh1=0;
...
%CHECKING IF 2ND CONSTRAINT IS SATISFIED
 if(rrh1&&rrh2&&rrh3&&rrh4&&rrh5&&rrh6<30)
 end
sum(rbs_val3);
% Second Cross
Cross2=cat(1,B1,A2);
...
best_sol_GA=min(n);
best_sol_GA100=best_sol_GA*(100/7);
